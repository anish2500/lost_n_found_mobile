...
class BatchApiModel {
  final String? id;
  final String
  batchName; //ya ko batchName ra batch postman bata add gardako batchName same huna paryo change ni garna painxa
  final String?
  status; //create garda afai implement huney bhayera question mark

  BatchApiModel({this.id, required this.batchName, this.status});

  //Api understand json only so make tojson and fromjson
